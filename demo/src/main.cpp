...
void run()
{
    ...
    const static int defaultW = 1920;
    const static int defaultH = 1080;
    const static int defaultScaling = 2;
    desc.w = defaultW / defaultScaling;
    desc.h = defaultH / defaultScaling;
